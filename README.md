...
1. 注册 [华为开发者账号](https://developer.huawei.com/consumer/cn/) 并实名认证
2. 创建项目和应用，开通 Health Kit 服务
3. 获取 Client ID 和 Client Secret
4. 使用 OAuth2 授权获取 Access Token 和 Refresh Token

> ⏳ Health Kit 审核需要 1-3 个工作日
...
| `HUAWEI_REFRESH_TOKEN` | 华为健康刷新令牌 | ✅ |
| `HUAWEI_CLIENT_ID` | 应用的 Client ID | ✅ |
| `HUAWEI_CLIENT_SECRET` | 应用的 Client Secret | ✅ |
| `AI_API_KEY` | AI API 密钥（用于健康建议） | 可选 |
| `AI_BASE_URL` | AI API 地址 | 可选 |

> ✅ 配置好 Client ID 和 Client Secret 后，GitHub Actions 会自动刷新 Token，无需手动更新！
